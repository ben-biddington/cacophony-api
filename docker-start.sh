...
sudo docker exec cacophony-api-test bash -c "sudo -i -u postgres psql cacophonytest -c \"\dt;\""
sudo docker exec cacophony-api-test bash -c "sudo -i -u postgres psql cacophonytest -f docker-seed.sh"
